...
{
  private final static int POINTSIZE = 3;//tamanho dos pontos
  private final static float FADE_INCR = 0.05f;//cor

  private static final float GRAVITY = 9.8f;//raio de acçao
  ...
  { 
    //cs[i] = -20.0f; cs[i+1] = 1.25f; cs[i+2] = -1.00f;   // (x,y,z) at origin
      cs[i] = -20.0f; cs[i+1] = 1.8f; cs[i+2] = -10.0f;   // (x,y,z) at origin
